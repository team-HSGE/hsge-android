...
import com.starters.hsge.databinding.FragmentDialogSplashBinding

class SplashDialogFragment : DialogFragment() {

    private lateinit var binding: FragmentDialogSplashBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_dialog_splash,
            container,
            false
        )
...
//    }
    ...
    override fun onResume() {
        ...
        dialogFragmentResize(requireContext(), this@SplashDialogFragment, 0.8f, 0.22f)
    }
}