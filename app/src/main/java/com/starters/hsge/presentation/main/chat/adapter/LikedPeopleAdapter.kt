...
class LikedPeopleAdapter(
    private var likedPeopleResponseList: List<LikedPeopleResponse>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LikedPeopleViewHolder {
        val binding =
            ItemLikedPeopleBinding.inflate(LayoutInflater.from(parent.context), parent, false)
