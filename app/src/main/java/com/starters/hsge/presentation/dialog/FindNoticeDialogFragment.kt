...
import com.starters.hsge.databinding.FragmentFindNoticeDialogBinding

class FindNoticeDialogFragment: DialogFragment() {

    private lateinit var binding: FragmentFindNoticeDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_find_notice_dialog,
            container,
            false
        )
    ...
    override fun onResume() {
        ...
        dialogFragmentResize(requireContext(), this@FindNoticeDialogFragment, 0.9f, 0.68f)
    }
